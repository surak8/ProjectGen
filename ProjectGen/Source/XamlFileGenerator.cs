...
namespace NSprojectgen {
    ...
    public static class XamlFileGenerator {
        ...
        static void createMainFile(string outCSName, string nameSpace, string fname, string ename, CodeDomProvider cdp, string modelName, CodeGeneratorOptions opts, bool generateViewModel, IXamlFileGenerationData ixfgd) {
            CodeCompileUnit ccu = null;
            CodeNamespace ns0, ns;
            CodeTypeDeclaration ctd;
